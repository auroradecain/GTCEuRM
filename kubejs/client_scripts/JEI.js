JEIEvents.hideItems(event =>{
    ...
    event.hide(/mysticalagriculture:whiterproof_.*/)
    event.hide(["mysticalagriculture:enchanter", "mysticalagriculture:thinkering_table"])
    ...
    event.hide(["mysticalagriculture:infusion_crystal", "mysticalagriculture:master_infusion_crystal", "mysticalagriculture:upgrade_base"])
    event.hide(["mysticalagradditions:insanium_essence", "mysticalagradditions:insanium_block", "mysticalagradditions:insanium_ingot", "mysticalagradditions:insanium_ingot_block", "mysticalagradditions:insanium_nugget", "mysticalagradditions:insanium_farmland", "mysticalagradditions:creative_essence"])

    const infTiers = ["inferium", "prudentium", "tertium", "imperium", "supremium", "awakened_supremium", "insanium"]
    ...
    infTiers.forEach(tier =>{
        event.hide([
            ...
            `mysticalagradditions:${tier}_coal`,
            `mysticalagradditions:${tier}_coal_block`,
            
            `mysticalagradditions:${tier}_paxel`,
