JEIEvents.hideItems(event =>{
    ...
    event.hide(/mysticalagraddition:*_ore/)
    event.hide(/mysticalagriculture:*_ore/)
    event.hide(["mysticalagriculture:inferium_essence", "mysticalagriculture:inferium_ingot", "mysticalagriculture:prudentium_essence", "mysticalagriculture:prudentium_ingot", "mysticalagriculture:tertium_essence", "mysticalagriculture:tertium_ingot", "mysticalagriculture:imperium_essence", "mysticalagriculture:imperium_ingot", "mysticalagriculture:supremium_essence", "mysticalagriculture:supremium_ingot", "mysticalagriculture:awakened_supremium_essence", "mysticalagriculture:awakened_supremium_ingot"])
    event.hide(["mysticalagriculture:inferium_growth_accelerator", "mysticalagriculture:prudentium_growth_accelerator", "mysticalagriculture:tertium_growth_accelerator", "mysticalagriculture:imperium_growth_accelerator", "mysticalagriculture:supremium_growth_accelerator"])
    event.hide(["mysticalagriculture:watering_can", "mysticalagriculture:inferium_watering_can", "mysticalagriculture:prudentium_watering_can", "mysticalagriculture:tertium_watering_can", "mysticalagriculture:imperium_watering_can", "mysticalagriculture:supremium_watering_can", "mysticalagriculture:awakened_supremium_watering_can"])
...
JEIEvents.addItems(event =>{
    event.add(Item.of("ae2:facade", {item: "gtceu:viadium_block"}))
})