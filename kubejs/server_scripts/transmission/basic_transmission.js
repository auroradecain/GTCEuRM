ServerEvents.recipes(event => {
    ...
    data_transmission(event, "overworld", 1, 1).forEach(builder =>{
        builder
            ...
            .itemInputs("64x #forge:logs")
            .itemInputs("64x #forge:logs")
            .itemInputs("64x #minecraft:saplings")
            .itemInputs("64x #minecraft:saplings")
            .itemInputs("64x #forge:crops")
    ...
    data_transmission(event, "nether", 2, 1).forEach(builder =>{
        builder
            ...
            .itemInputs("32x #forge:gems/quartz")
    ...
    data_transmission(event, "end", 3, 1).forEach(builder =>{
        builder
            .dimension("minecraft:the_end")
            ...
            .itemInputs("8x #forge:ender_pearls")
