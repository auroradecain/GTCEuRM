ServerEvents.recipes(event=>{
    data_receive(event, 'overworld', 1, 1).forEach(builder=>{
        builder
            ...
            .chancedOutput('kubejs:forest_biome_core', 2400, 250)
            .chancedOutput('kubejs:ocean_biome_core', 2400, 250)
            .chancedOutput('kubejs:desert_biome_core', 2400, 250)
            .chancedOutput('kubejs:beach_biome_core', 2400, 250)
            .chancedOutput('kubejs:hills_biome_core', 2400, 250)
            .chancedOutput('kubejs:plains_biome_core', 2400, 250)
            .chancedOutput('kubejs:meadow_biome_core', 2400, 250)
    })
