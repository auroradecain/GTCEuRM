...
GTCEuStartupEvents.registry('gtceu:machine', event=>{
    ...
    event.create('critical_point_crystal_matrix', 'multiblock')
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .aisle('XXXXXXXXX', 'XXXXXXXXX', 'XXXXXXXXX', 'XXXACAXXX', 'XXXBEBXXX', 'XXXAAAXXX')
            ...
            .aisle('XXXDDDXXX', 'XXXB BXXX', 'XXXB BXXX', 'ACAA AACA', 'BEEE EEEB', 'AAAAAAAAA')
            .aisle('XXXDDDXXX', 'XXXA@AXXX', 'XXXAAAXXX', 'AAAAAAAAA', 'BBBAEABBB', 'AAAAAAAAA')
            .aisle('XXXXXXXXX', 'XXXXXXXXX', 'XXXXXXXXX', 'XXXAAAXXX', 'XXXBEBXXX', 'XXXAAAXXX')
            .aisle('XXXXXXXXX', 'XXXXXXXXX', 'XXXXXXXXX', 'XXXACAXXX', 'XXXBEBXXX', 'XXXAAAXXX')
            .aisle('XXXXXXXXX', 'XXXXXXXXX', 'XXXXXXXXX', 'XXXAAAXXX', 'XXXBBBXXX', 'XXXAAAXXX')
            .where('@', Predicates.controller(Predicates.blocks(definition.get())))
            .where('A', Predicates.blocks(GTBlocks.CASING_ALUMINIUM_FROSTPROOF))
            .where('B', Predicates.blocks(GTBlocks.CASING_TEMPERED_GLASS))
            .where('C', Predicates.abilities(PartAbility.IMPORT_FLUIDS))
    ...
    event.create('draconitium_reactor', 'multiblock')
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .aisle('XXAXXXXXXXXXAXX', 'XE CXXXXXXXC EX', 'XXAXXXXXXXXXAXX')
            .aisle('XXXAXXXXXXXAXXX', 'XXCBCEXXXECBCXX', 'XXXAXXXXXXXAXXX')
            .aisle('XXXXAAAAAAAXXXX', 'XXXC  AAA  CXXX', 'XXXXAAAAAAAXXXX')
            .aisle('XXXXXXAAAXXXXXX', 'XXXXEEAAAEEXXXX', 'XXXXXXAAAXXXXXX')
            .aisle('XXXXXXDADXXXXXX', 'XXXXXXA@AXXXXXX', 'XXXXXXDADXXXXXX')
            .where('@', Predicates.controller(Predicates.blocks(definition.get())))
            .where('A', Predicates.blocks("kubejs:draconitium_fusion_casing"))
            .where('B', Predicates.blocks(GTBlocks.SUPERCONDUCTING_COIL))
            ...
            .where(' ', Predicates.air())
            .build())
        .workableCasingRenderer("kubejs:block/draconitium/draconitium_fusion_casing", "gtceu:block/multiblock/fusion_reactor", false)
})