...
GTCEuStartupEvents.registry('gtceu:machine', event=>{
    ...
    event.create('critical_point_crystal_matrix', 'multiblock')
        ...
        .appearanceBlock(() => Block.getBlock("kubejs:supremium_casing"))
        .pattern(definition => FactoryBlockPattern.start()
            .aisle('XXXCCCCCXXX', 'XXXDXXXDXXX', 'XXXDXXXDXXX', 'XXXDXXXDXXX', 'XXXXXXXXXXX', 'XXXXXXXXXXX', 'XXXXXXXXXXX', 'XXXDXXXDXXX', 'XXXDXXXDXXX', 'XXXDXXXDXXX', 'XXXCCCCCXXX')
            .aisle('XXCCCCCCCXX', 'XXXXCCCXXXX', 'XXXXBBBXXXX', 'XXXDAAADXXX', 'XXXDDDDDXXX', 'XXXXDXDXXXX', 'XXXDDDDDXXX', 'XXXDAAADXXX', 'XXXXBBBXXXX', 'XXXXCCCXXXX', 'XXCCCCCCCXX')
            .aisle('XCCCCCCCCCX', 'XXXXCCCXXXX', 'XXXXBEBXXXX', 'XXXXACAXXXX', 'XXDXXXXXDXX', 'XXXXXXXXXXX', 'XXDXXXXXDXX', 'XXXXAAAXXXX', 'XXXXBEBXXXX', 'XXXXCCCXXXX', 'XCCCCCCCCCX')
            .aisle('CCCCCCCCCCC', 'DXXXCCCXXXD', 'DXXXBEBXXXD', 'DDXXAAAXXDD', 'XDXXXXXXXDX', 'XXXXXXXXXXX', 'XDXXXXXXXDX', 'DDXXAAAXXDD', 'DXXXBEBXXXD', 'DXXXCCCXXXD', 'CCCCCCCCCCC')
            .aisle('CCCCCCCCCCC', 'XCCCCCCCCCX', 'XBBBAEABBBX', 'XAAAAAAAAAX', 'XDXXABAXXDX', 'XDXXABAXXDX', 'XDXXABAXXDX', 'XAAAAAAAAAX', 'XBBBAEABBBX', 'XCCCCCCCCCX', 'CCCCCCCCCCC')
            .aisle('CCCCCCCCCCC', 'XCCCCCCCCCX', 'XBEEE EEEBX', 'XACAA AACAX', 'XDXXB BXXDX', 'XXXXB BXXXX', 'XDXXB BXXDX', 'XAAAA AAAAX', 'XBEEE EEEBX', 'XCCCCCCCCCX', 'CCCCCCCCCCC')
            .aisle('CCCCCCCCCCC', 'XCCCCCCCCCX', 'XBBBAEABBBX', 'XAAAAAAAAAX', 'XDXXAAAXXDX', 'XDXXABAXXDX', 'XDXXAAAXXDX', 'XAAAAAAAAAX', 'XBBBAEABBBX', 'XCCCCCCCCCX', 'CCCCCCCCCCC')
            .aisle('CCCCCCCCCCC', 'DXXXCCCXXXD', 'DXXXBEBXXXD', 'DDXXAAAXXDD', 'XDXXXXXXXDX', 'XXXXXXXXXXX', 'XDXXXXXXXDX', 'DDXXAAAXXDD', 'DXXXBEBXXXD', 'DXXXCCCXXXD', 'CCCCCCCCCCC')
            .aisle('XCCCCCCCCCX', 'XXXXCCCXXXX', 'XXXXBEBXXXX', 'XXXXACAXXXX', 'XXDXXXXXDXX', 'XXXXXXXXXXX', 'XXDXXXXXDXX', 'XXXXAAAXXXX', 'XXXXBEBXXXX', 'XXXXCCCXXXX', 'XCCCCCCCCCX')
            .aisle('XXCCCCCCCXX', 'XXXXC@CXXXX', 'XXXXBBBXXXX', 'XXXDAAADXXX', 'XXXDDDDDXXX', 'XXXXDXDXXXX', 'XXXDDDDDXXX', 'XXXDAAADXXX', 'XXXXBBBXXXX', 'XXXXCCCXXXX', 'XXCCCCCCCXX')
            .aisle('XXXCCCCCXXX', 'XXXDXXXDXXX', 'XXXDXXXDXXX', 'XXXDXXXDXXX', 'XXXXXXXXXXX', 'XXXXXXXXXXX', 'XXXXXXXXXXX', 'XXXDXXXDXXX', 'XXXDXXXDXXX', 'XXXDXXXDXXX', 'XXXCCCCCXXX')
            .where('@', Predicates.controller(Predicates.blocks(definition.get())))
            .where('A', Predicates.blocks("kubejs:supremium_casing"))
